...
from curio.runtime.browser import browse
...
from curio.runtime.utils import split_bash_commands
from curio.runtime.utils.files import insert_lines, read_lines
    ...
    async def ainit(self):
        ...
        if 'agent_skills' in self.plugins and 'jupyter' in self.plugins:
            obs = await self.run_ipython(
                IPythonRunCellAction(
                    code='from curio.runtime.plugins.agent_skills.agentskills import *\n'
                )
            )
